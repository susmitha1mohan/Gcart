...
@Configuration
@ComponentScan(basePackages = { "com.rush.Gcart.model" })
@EnableTransactionManagement
public class HibernateConfig {
	
	
	// Change the below based on the DBMS you choose
		private final static String DATABASE_URL = "jdbc:h2:tcp://localhost/~/Gcart";
		...
		public SessionFactory getSessionFactory(DataSource dataSource) {
			...
			builder.scanPackages("com.rush.Gcart.model");
